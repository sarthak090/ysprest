...
export default function PrivacyPage({ pageData, seoData }: any) {
  return (
    <>
      ...
      <Seo title={pageData.title.rendered} url="submission-guidelines" />
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  const seoURL = `${NEXT_PUBLIC_CMS}/wp-json/rankmath/v1/getHead?url=${NEXT_PUBLIC_CMS}/submission-guidelines`;
  const url = `${NEXT_PUBLIC_CMS}/wp-json/wp/v2/pages/29`;
