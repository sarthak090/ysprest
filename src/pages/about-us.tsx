...
export default function PrivacyPage({ pageData, seoData }: any) {
  return (
    <>
      ...
      <section className="about-us mx-auto w-full max-w-1920 bg-light py-8 px-4 lg:py-10 lg:px-8 xl:py-14 xl:px-16 2xl:px-20">
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  const seoURL = `${NEXT_PUBLIC_CMS}/wp-json/rankmath/v1/getHead?url=${NEXT_PUBLIC_CMS}/about-us`;
  const url = `${NEXT_PUBLIC_CMS}/wp-json/wp/v2/pages/31`;
