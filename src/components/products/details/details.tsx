...
const Details: React.FC<Props> = ({
  ...
  if (isSelected && product?.variation_options_test?.length > 0) {
    // selectedVariation = product?.variation_options_test?.find((o: any) =>
    //   isEqual(
    ...
    selectedVariation = product?.variation_options_test?.find(
      (o: any) => o.id === attributes.id
    );
  }
  ...
  return (
    <article className="rounded-lg bg-light">
      ...
      <Element name="details" className="     ">
        {details && (
          <div className="px-40 ">
