...
type FeeLine = {
  ...
  total: string;
  total_tax: string;
  taxes: any[]; // You can replace 'any' with a more specific type if you have information about the structure of taxes array
  meta_data: any[]; // You can replace 'any' with a more specific type if you have information about the structure of meta_data array
};
type TaxLine = {
  id: number;
  rate_code: string;
