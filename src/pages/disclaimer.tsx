...
export default function PrivacyPage({ pageData, seoData }: any) {
  return (
    <>
      ...
      <Seo title={pageData.title.rendered} url="disclaimer" />
      <section className=" disclaimer mx-auto w-full max-w-1920 bg-light py-8 px-4 lg:py-10 lg:px-8 xl:py-14 xl:px-16 2xl:px-20">
...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  const seoURL = `${NEXT_PUBLIC_CMS}/wp-json/rankmath/v1/getHead?url=${NEXT_PUBLIC_CMS}/disclaimer`;
  const url = `${NEXT_PUBLIC_CMS}/wp-json/wp/v2/pages/6172`;
