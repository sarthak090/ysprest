    ...
    case 'neon':
      return (
        <button
          ...
          disabled={disabled}
          style={{
            backgroundImage: 'linear-gradient(90deg, #166AB4 0%, #34BAFF 100%)',
          }}
          className="group mx-auto flex h-7  items-center justify-between rounded bg-gray-100 px-4 text-xs text-white   transition-colors hover:border-accent hover:bg-accent hover:text-light focus:border-accent focus:bg-accent focus:text-light focus:outline-none md:h-9 md:text-sm"
        >
