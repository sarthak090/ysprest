...
import type { CreateLinkExchangeSubmittion } from '@/types';
...
const LinkExchangeSubmittionForm = () => {
  const { t } = useTranslation('common');
  const [html, setHTml] = useState('');

  function onSubmit(values: CreateLinkExchangeSubmittion) {
    fetch('/api/link-exchange-form', {
      ...
      .then((res) =>
        toast.success(
          `Link exchange guest post article has been sent successfully.
          `
        )
      )
  ...
  return (
    <Form<CreateLinkExchangeSubmittion>
      onSubmit={onSubmit}
...
export default LinkExchangeSubmittionForm;
