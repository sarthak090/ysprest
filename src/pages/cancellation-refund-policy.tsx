...
export const getStaticProps: GetStaticProps = async ({ locale }) => {
  ...
  const seoURL = `${NEXT_PUBLIC_CMS}/wp-json/rankmath/v1/getHead?url=${NEXT_PUBLIC_CMS}/cancellation-refund-policy`;
  const url = `${NEXT_PUBLIC_CMS}/wp-json/wp/v2/pages/12815`;
