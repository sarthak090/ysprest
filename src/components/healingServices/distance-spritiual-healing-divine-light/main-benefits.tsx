export default function MainBenefits() {
  const benefits = [
    `Restores inner peace & calmness of mind & soul

          `,
    `Offers a sense of self-awakening

          `,
    `Promotes overall good health & well being

          `,
    `Boosts morale, confidence & courage

          `,
    `Offers a clarified approach towards life

          `,
    `Fights chronic pains & physical imbalances

          `,
    `Heals mental & emotional past life wounds
          `,
    `Improves focus & rationale behavior
          `,
    `Strengthens immune system & emotional stability
          `,
    `Overcomes stress, anxiousness, fear & insecurities
          `,
  ];
  return (
