  ...
  return (
    <>
      ...
      <section className="lg:px-16">
        <div className="grid grid-cols-3">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-center">
              Once you sign up for the healing session, you will be connected to
              one of our reiki therapists via Email. The reiki therapist will
              identify your energy imbalances, blockages, traumas, wishes, and
              any other aspect affecting your health & wellbeing.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center">
            <svg
            ...
            <p className="text-center">
              ...
              therapists use various reiki therapies to give you desired results
              like Angel Reiki, Crystal Reiki, Usui Reiki, Karuna Reiki and
              Intent Reiki.
            </p>
          </div>
          <div className="flex flex-col items-center justify-center">
        ...
        <section className="my-8">
          <p className="my-24 text-center text-[24px] font-semibold text-[#0A2D4D]">
            Remove hidden blockages from your financial growth & pave the way
            for money success & prosperity
          </p>
          <div id="buynow" className="flex gap-6">
            <div>
              <img
                src="https://yourspiritualrevolution.org/wp-content/uploads/2022/01/2.jpg"
                alt=""
                width={600}
            ...
            <div className="grid gap-5">
              ...
              <p className="text-[20px]">
                Manifest wealth, prosperity, money abundance & success with the
                powerful money reiki healing!
              </p>
              <p className="text-[20px]">
                Powerful Healing for 7 Days of Money Reiki
              </p>
              <p className="text-[20px]">Price: ₹6,999 (Incl. GST) / US $129</p>
              <button
                onClick={onClick}
                style={{
