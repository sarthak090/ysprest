  ...
  return (
    <>
      ...
      >
        ...
        <option value="8Antigua &amp; Barbuda (+1268)">
          8Antigua &amp; Barbuda (+1268)
        </option>
        ...
        <option value="8Trinidad &amp; Tobago (+1868)">
          8Trinidad &amp; Tobago (+1868)
        </option>
        <option value="Tunisia (+216)">Tunisia (+216)</option>
        <option value="Turkey (+90)">Turkey (+90)</option>
        <option value="Turkmenistan (+7)">Turkmenistan (+7)</option>
        <option value="Turkmenistan (+993)">Turkmenistan (+993)</option>
        <option value="9Turks &amp; Caicos Islands (+1649)">
          9Turks &amp; Caicos Islands (+1649)
        </option>
